/obj/machinery/autolathe
	...
	var/list/stored_material =  list(DEFAULT_WALL_MATERIAL = 0, "glass" = 0, DEFAULT_TABLE_MATERIAL = 0)
	var/list/storage_capacity = list(DEFAULT_WALL_MATERIAL = 0, "glass" = 0, DEFAULT_TABLE_MATERIAL = 0)
...
/obj/machinery/autolathe/RefreshParts()
	...
	storage_capacity[DEFAULT_TABLE_MATERIAL] = mb_rating  * 25000
